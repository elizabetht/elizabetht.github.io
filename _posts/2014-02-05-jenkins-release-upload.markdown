...
![Jenkins Services Management](/images/jenkins-services-properties.png "Jenkins Services Management") 
...
![Jenkins Logon](/images/jenkins-logon.png "Jenkins Logon") 
...
![Jenkins Restart](/images/jenkins-services-restart.png "Jenkins Restart") 
...
![Jenkins Nexus-Pro](/images/jenkins-nexus-pro.png "Jenkins Nexus-Pro")  
...
![Jenkins New Job](/images/jenkins-newjob.png "Jenkins New Job")
...
![Jenkins Source Code Management for Release](/images/jenkins-sourcecodemgmt-release.png "Jenkins Source Code Management for Release")

Proceed to the Build Environment section, enable Maven Release Build option and enter the release goals.

![Jenkins Maven Release Build](/images/jenkins-maven-releasebuild.png "Jenkins Maven Release Build")
...
![Jenkins Perform Maven Release](/images/jenkins-perform-maven-release.png "Jenkins Perform Maven Release")
